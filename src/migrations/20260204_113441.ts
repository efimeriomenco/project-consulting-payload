...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_cta_links_link_type" AS ENUM('reference', 'custom', 'phone');
  CREATE TYPE "public"."enum_pages_blocks_cta_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE "public"."enum_pages_blocks_content_columns_link_type" AS ENUM('reference', 'custom', 'phone');
  ...
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'withImage');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_link_type" AS ENUM('reference', 'custom', 'phone');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_link_type" AS ENUM('reference', 'custom', 'phone');
  ...
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'withImage');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('ro', 'ru', 'en');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('ro', 'ru', 'en');
  CREATE TYPE "public"."enum_forms_confirmation_type" AS ENUM('message', 'redirect');
  CREATE TYPE "public"."enum_header_nav_items_sub_items_link_type" AS ENUM('reference', 'custom', 'phone');
  CREATE TYPE "public"."enum_header_nav_items_link_type" AS ENUM('reference', 'custom', 'phone');
  CREATE TYPE "public"."enum_header_button_link_type" AS ENUM('reference', 'custom', 'phone');
  CREATE TYPE "public"."enum_footer_column1_links_link_type" AS ENUM('reference', 'custom', 'phone');
  CREATE TYPE "public"."enum_footer_copyright_legal_links_link_type" AS ENUM('reference', 'custom', 'phone');
  CREATE TYPE "public"."enum_footer_nav_items_link_type" AS ENUM('reference', 'custom', 'phone');
  ...
  CREATE TABLE "pages" (
  	...
  	"hero_type" "enum_pages_hero_type" DEFAULT 'withImage',
  ...
  CREATE TABLE "_pages_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_hero_type" "enum__pages_v_version_hero_type" DEFAULT 'withImage',
  ...
  CREATE TABLE "header" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_id" integer,
  	"button_link_type" "enum_header_button_link_type" DEFAULT 'reference',
  	"button_link_new_tab" boolean,
  	"button_link_url" varchar,
  	"button_link_phone" varchar,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "header_locales" (
  	"menu_label" varchar DEFAULT 'Meniu',
  	"button_link_label" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  CREATE TABLE "footer_column1_links_locales" (
  	"link_label" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "footer_copyright_legal_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_copyright_legal_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_phone" varchar
  );
  
  CREATE TABLE "footer_copyright_legal_links_locales" (
  	"link_label" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "footer" (
  	...
  	"column2_phone" varchar,
  	"column2_email" varchar,
  	"column3_phone" varchar,
  	"contact_us_phone" varchar,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "footer_locales" (
  	"column1_title" varchar,
  	"column2_title" varchar,
  	"column3_title" varchar,
  	"column3_street" varchar,
  	"contact_us_title" varchar,
  	"contact_us_button_text" varchar,
  	"copyright_copyright_text" varchar DEFAULT '© 2026 Your Company. All rights reserved.',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  ALTER TABLE "footer_column1_links_locales" ADD CONSTRAINT "footer_column1_links_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_column1_links"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_copyright_legal_links" ADD CONSTRAINT "footer_copyright_legal_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_copyright_legal_links_locales" ADD CONSTRAINT "footer_copyright_legal_links_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_copyright_legal_links"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "footer_column1_links_locales_locale_parent_id_unique" ON "footer_column1_links_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "footer_copyright_legal_links_order_idx" ON "footer_copyright_legal_links" USING btree ("_order");
  CREATE INDEX "footer_copyright_legal_links_parent_id_idx" ON "footer_copyright_legal_links" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "footer_copyright_legal_links_locales_locale_parent_id_unique" ON "footer_copyright_legal_links_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "footer_column1_links_locales" CASCADE;
  DROP TABLE "footer_copyright_legal_links" CASCADE;
  DROP TABLE "footer_copyright_legal_links_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_header_button_link_type";
  DROP TYPE "public"."enum_footer_column1_links_link_type";
  DROP TYPE "public"."enum_footer_copyright_legal_links_link_type";
